...
- Apresentação do problema e tentativa de convencer o leitor de que o tópico é importante. O balanço adequado entre uma apresentação geral do tema e uma discussão detalhada de alguns componentes envolvidos no problema não é fácil de ser atingido, mas deve ser perseguido. A relevância do tema pode ser explorada de várias formas, vai depender muito da natureza do Projeto Final. Custos e benefícios envolvidos, pessoas afetadas, demanda governamental ou privada para a solução de algum problema são exemplos de elementos que costumam ser utilizados para expressar a relevância do tema.    

- Descrição geral do que vem sendo feito na literatura científica, ou na prática da engenharia, para abordar o problema em pauta. É importante aqui preparar o terreno na cabeça do leitor identificando alguma lacuna metodológica ou dificuldade de ordem prática na solução do problema. A lógica aqui é deixar claro que os objetivos propostos por você para este trabalho, a serem descritos na próxima seção do documento, sejam percebidos como algo necessário para tratar o problema (não necessariamente resolvê-lo). Pense nesta etapa da Introdução como uma forma de mostrar que atingir os objetivos propostos no seu trabalho é um passo coerente no avanço científico ou tecnológico.
