...
- Apresentação do problema e tentativa de convencer o leitor de que o tópico é importante. O balanço adequado entre uma apresentação geral do tema e uma discussão detalhada de alguns componentes envolvidos no problema não é fácil de ser atingido, mas deve ser perseguido. A relevância do tema pode ser explorada de várias formas, vai depender muito da natureza do Projeto Final. Custos e benefícios envolvidos, pessoas afetadas, demanda governamental ou privada para a soluçao de algum problema são exemplos de elementos que costumam ser utilizados para expressar a relevância do tema.    
